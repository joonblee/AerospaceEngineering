...
p(1)=plot(PHI,Freq_Mass_L./Freq0,'b','LineStyle','--','LineWidth',1.1,'DisplayName','1M, j = L (Analytic)');
p(2)=plot(phi_FEM,Freq_Mass_L_FEM/Freq_Mass_perfect_FEM,'bo','DisplayName','1M, j = L (FEM)');
p(3)=plot(PHI,Freq_Mass_H./Freq0,'color',[0.58 0 0.83],'LineStyle','--','LineWidth',1.1,'DisplayName','1M, j = H (Analytic)');
p(4)=plot(phi_FEM,Freq_Mass_H_FEM/Freq_Mass_perfect_FEM,'d','color',[0.58 0 0.83],'DisplayName','1M, j = H (FEM)');
p(5)=plot(PHI,Freq_Hole_L./Freq0,'r','LineStyle',':','LineWidth',1.5,'DisplayName','1H, j = L (Analytic)');
p(6)=plot(phi_FEM,Freq_Hole_L_FEM/Freq_Mass_perfect_FEM,'rs','DisplayName','1H, j = L (FEM)');
p(7)=plot(PHI,Freq_Hole_H./Freq0,'color',[1.0 0.5 0.0],'LineStyle',':','LineWidth',1.5,'DisplayName','1H, j = H (Analytic)');
p(8)=plot(phi_FEM,Freq_Hole_H_FEM/Freq_Mass_perfect_FEM,'^','color',[1.0 0.5 0.0],'DisplayName','1H, j = H (FEM)');
